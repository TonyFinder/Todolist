...
import {
    addTodolistAC,
    changeTodolistTitleAC, FilterProps,
    filterTaskAC,
...
test('set todolists', () => {
    ...
    let todolists: TodolistStateType[] = [
        {id: todolistId1, title: "What to sing", filter: "All", order: 0, addedDate: ""},
        {id: todolistId2, title: "What to wash", filter: "All", order: 0, addedDate: ""}
    ]
